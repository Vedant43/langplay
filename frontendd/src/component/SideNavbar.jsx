...
const SideNavbar = ({ sidenavbar }) => {
  return (
    <div className={sidenavbar ? "fixed top-[55px] left-0 w-[275px] h-[92vh] flex flex-col p-3.5 bg-white text-black overflow-y-auto scrollbar-hidden" : "hidden"}>
      {/* Top Section */}
      <div className="flex flex-col border-b border-[#565555] pb-2.5">
        <div className="flex gap-5 items-center p-2.5 cursor-pointer hover:bg-[#f2f2f2] hover:rounded-[15px]">
          <HomeIcon />
